...
'Deogol', 'Derian', 'Drefan', 'Dreogan', 'Eadig', 'Eadlyn', 'Eamon', 'Ecgfrith', 'Edmund', 'Edmund', 'Eldrid',
'Eorl', 'Farmon', 'Garrett', 'Geoff', 'Gildas', 'Gimm', 'Graeme', 'Grendel', 'Grimbold', 'Grimme', 'Halig',
'Ham', 'Landry', 'Lange', 'Lar', 'Leax', 'Leng', 'Leof', 'Lin', 'List', 'Lufian', 'Manton',
'Norville', 'Odi', 'Odin', 'Oswine', 'Peada', 'Perry', 'Pierce', 'Prasutagus', 'Ramm', 'Rand', 'Rinc',
...
'Devona', 'Dohtor', 'Don', 'Eacnung', 'Eadgyth', 'Easter', 'Eda', 'Edith', 'Edlyn', 'Edmunda', 'Edrys',
'Eldrida', 'Elene', 'Elga', 'Ellenweorc', 'Ellette', 'Elswyth', 'Elva', 'Elvina', 'Engel', 'Eostre', 'Erlina',
'Esma', 'Estra', 'Etheswitha', 'Freya', 'Garmangabis', 'Hamia', 'Harimilla', 'Hilda', 'Ifield', 'Juliana', 'Kendra',
'Linette', 'Lora', 'Loretta', 'Lyn', 'Mae', 'Maida', 'Megan', 'Mercia', 'Moira', 'Nelda', 'Nerthus',
'Odelia', 'Ora', 'Orva', 'Osberga', 'Rheda', 'Rowena', 'Sibley', 'Silver', 'Sulis', 'Sunniva', 'Tate',
